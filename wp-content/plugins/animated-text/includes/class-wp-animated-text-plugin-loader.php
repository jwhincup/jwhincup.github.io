 ...
 */
class Wp_Animated_Text_Plugin_Loader {
	 ...
	 * @param object $component The component to handle the short code.
	 * @param string $callback The function to handle the short code.
	 */
